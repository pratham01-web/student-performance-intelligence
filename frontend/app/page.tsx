...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      const guest = sessionStorage.getItem("spi_guest");
      if (!stored && !guest) {
    ...
    <div className="space-y-8 max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-neutral-900 pb-5">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/predict"
            className="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2 text-xs font-semibold text-black shadow-sm hover:bg-neutral-200 transition-colors cursor-pointer"
          >
          ...
          <Link
            href="/students"
            className="inline-flex items-center gap-2 rounded-lg border border-neutral-800 bg-neutral-950 px-4 py-2 text-xs font-semibold text-neutral-300 hover:bg-neutral-900 hover:text-white transition-colors cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-neutral-850 bg-black/60 p-6 backdrop-blur-md shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-base font-semibold text-white">Longitudinal Performance Trends</h2>
              <p className="text-xs text-neutral-400">Mean examination score vs. attendance across sequential terms</p>
            </div>
            <span className="text-[11px] font-medium text-neutral-400 bg-neutral-950 border border-neutral-800 px-2 py-0.5 rounded">
              Term Comparison
            </span>
          </div>
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={semesterData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <XAxis dataKey="semester" stroke="#737373" fontSize={12} tickLine={false} />
                <YAxis stroke="#737373" fontSize={12} domain={[50, 100]} tickLine={false} />
                <Tooltip
                  contentStyle={{
        ...
        <div className="rounded-xl border border-neutral-850 bg-black/60 p-6 backdrop-blur-md shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-neutral-400">Pass rate and average marks grouped by attendance brackets</p>
            </div>
            <span className="text-[11px] font-medium text-neutral-400 bg-neutral-950 border border-neutral-800 px-2 py-0.5 rounded">
              Risk Indicator
            </span>
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={attendanceData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#262626" />
                <XAxis dataKey="band" stroke="#737373" fontSize={12} tickLine={false} />
                <YAxis stroke="#737373" fontSize={12} domain={[0, 100]} tickLine={false} />
                <Tooltip
                  contentStyle={{
                    backgroundColor: "#000000",
                    borderColor: "#262626",
                ...
                />
                <Legend wrapperStyle={{ fontSize: "12px", paddingTop: "8px" }} />
                <Bar dataKey="pass_rate" name="Pass Rate (%)" fill="#ffffff" radius={[4, 4, 0, 0]} />
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-neutral-850 bg-black/60 p-6 backdrop-blur-md shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-neutral-400">Average student marks segmented by daily revision hours</p>
            </div>
            <span className="text-[11px] font-medium text-neutral-400 bg-neutral-950 border border-neutral-800 px-2 py-0.5 rounded">
              Habit Analysis
            </span>
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={habitsData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#262626" />
                <XAxis dataKey="habit_range" stroke="#737373" fontSize={12} tickLine={false} />
                <YAxis stroke="#737373" fontSize={12} domain={[40, 90]} tickLine={false} />
                <Tooltip
                  contentStyle={{
                    backgroundColor: "#000000",
                    borderColor: "#262626",
        ...
        {/* Executive Intervention & Academic Risk Overview */}
        <div className="rounded-xl border border-neutral-850 bg-black/60 p-6 backdrop-blur-md shadow-lg flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div>
                <h2 className="text-base font-semibold text-white">Cohort Grade Distribution &amp; Risk Health</h2>
                <p className="text-xs text-neutral-400">Institutional tier breakdown based on current term evaluations</p>
              </div>
              <span className="text-[11px] font-medium px-2 py-0.5 rounded bg-neutral-900 text-neutral-300 border border-neutral-800">
                Active Cohort
              </span>
            </div>
            ...
            <div className="space-y-3.5 mt-4">
              <div>
                <div className="flex justify-between text-xs font-medium mb-1">
                  <span className="text-neutral-200">Distinction (75% - 100%)</span>
              ...
              <div>
                <div className="flex justify-between text-xs font-medium mb-1">
                  <span className="text-neutral-200">First Class (60% - 74%)</span>
              ...
              <div>
                <div className="flex justify-between text-xs font-medium mb-1">
                  <span className="text-neutral-200">Second Class (50% - 59%)</span>
              ...
              <div>
                <div className="flex justify-between text-xs font-medium mb-1">
                  <span className="text-neutral-200">At-Risk Intervention Group (&lt;50%)</span>
            ...
            {/* Counselors Notice */}
            <div className="mt-5 rounded-lg border border-neutral-800 bg-neutral-950/80 p-3.5 flex items-start gap-3">
          ...
          <div className="mt-6 pt-4 border-t border-neutral-900 flex items-center justify-between">
            <span className="text-xs text-neutral-400">Total Evaluations Logged: {stats.total_predictions}</span>
            <Link
              href="/predict"
              className="text-xs font-semibold text-neutral-200 hover:text-white transition-colors flex items-center gap-1 cursor-pointer"
            >
